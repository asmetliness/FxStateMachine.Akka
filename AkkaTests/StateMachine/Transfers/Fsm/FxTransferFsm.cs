...
namespace AkkaTests.StateMachine.Transfers.Fsm
{
    ...
    public class FxTransferActor : PersistentFSM<IFxTransferState, IFxTransfer, IFxTransferEvents>
    {
        ...
        {
            return Akka.Actor.Props.Create(() => new FxTransferActor(transferId, mediator));
        }
        public FxTransferActor(Guid transferId, IMediator mediator)
        {
